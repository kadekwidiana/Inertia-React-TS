...
export default function Frontpage() {
    return (
        <>
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul
                            ...
                            <li>
                                <a href="#" className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0 "
                            ...
                            <li>
                                <a href="/login" className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:p-0 "
            ...
            {/* <!-- MAP --> */}
            {/* < div id="map-frontpage" className="map-container" >
